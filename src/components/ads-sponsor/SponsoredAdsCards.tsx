                ...
                <Box className="sponsore-card-item" sx={{ margin: "0 10px", display: "block", width: "93%", height: "100%" }}>
                    <Box className="sponsored-card"
                        sx={{
                            ...
                            bgcolor: "white", borderRadius: "10px", flexDirection: "column", maxWidth: "304px",
                            border: "1px solid rgba(0,0,0,.15)"
                        }}>
                        <Link href={link} target="_blank" sx={{ color: "black", transition: ".5s", textDecoration: "none", outline: "0" }}>
                            ...
                            <Box className="sponsor-details"
                                sx={{
                                    bgcolor: "white", padding: "20px", diplay: "flex", flexGrow: 1,
                                ...
                                <Box className="detail" sx={{ flexGrow: 1 }}>
                                    <Typography className='sponsor-ads-title' component="h4" sx={{
                                        ...
                                        lineHeight: "28px", marginBottom: "10px"
                                    }}>
                                        {title}</Typography>

                                    <Typography className='sponsor-ads-subtitle' sx={{
                                        fontSize: "12px", lineHeight: 1.4, color: "#00000080",
                                        margin: 0
                                    }}>
                                        {shortDescription}
                                    </Typography>
